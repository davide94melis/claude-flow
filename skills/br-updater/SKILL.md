...
- Se "Completata": lasciala completata, aggiungi nota `[REQUISITO RIMOSSO <data>]`
...
1. **Mai sovrascrivere il progresso** — le task completate restano completate, quelle in corso restano in corso
