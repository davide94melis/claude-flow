...
**Fallback AFU legacy**: se una delle due versioni non è feature-first (manca front-matter/§6), usa la detection testuale per requisito descritta sotto (comportamento storico).
