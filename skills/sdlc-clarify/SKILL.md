...
3. Confronta il file convertito con il CLARIFY.md originale. Per ogni domanda, cerca differenze nel testo dopo il campo "**Risposta del funzionale**":
...
**Aggiorna anche la copia EN:** dopo aver integrato le risposte nel `CLARIFY.md` primario, rigenera `CLARIFY.en.md` (traduzione allineata) nella stessa cartella, cosi' la copia inglese resta coerente col primario.
