...
**Copia in inglese (regola artefatti funzionali):** il `CLARIFY.md` primario e' nella lingua di interazione/prodotto (tipicamente `it`, leggibile dal funzionale). Genera **in aggiunta** `CLARIFY.en.md` nella stessa cartella: stessa struttura e stessi ID domanda, contenuto tradotto in inglese. La copia EN e' un artefatto di record; le risposte del funzionale si raccolgono sul `CLARIFY.md` primario (o sul DOCX legacy).
